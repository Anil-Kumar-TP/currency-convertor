    ...
    return (
        <div className='max-w-xl mx-auto my-10 p-5 bg-white rounded-lg shadow-md'>
            ...
            <div className='mt-4'>
                ...
                <input value={amount} onChange={(e) => setAmount(e.target.value)} type="number" className='w-full p-2 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-1' />
            </div>
